...
_saveToState: Function = (activeBackgroundColor: string, activeTintColor: string): null => {
  if (!this.state.isFinishedSaving) {
    this.state.isFinishedSaving = true
    this.setState({
      activeBackgroundColor,
      activeTintColor,
      inactiveBackgroundColor: activeTintColor
    })
  }
}
